...
void loop() {
  ...
  if(buttonMessages[0]){ // this is the left button
    Serial.println('');  // What do you want to print when the left button is pressed?
  }
  if(buttonMessages[1]){ // this is the middle button
    Serial.println('');  // What do you want to print when the middle button is pressed?
  }
  if(buttonMessages[2]){ // this is the right button
    Serial.println('');  // What do you want to print when the right button is pressed?
  }
...
void checkButtons(int button1, int button2, int button3){
  ...
  if(!isPressed1 && button1State == HIGH){
    ...
    isPressed1 = YOURCODE; // If the button is not being pressed, what value should isPressed have?
  }
  ...
  if(!isPressed2 && button2State == HIGH){
    ...
    isPressed2 = YOURCODE; // If the button is not being pressed, what value should isPressed have?
  }
  ...
  if(!isPressed3 && button3State == HIGH){
    ...
    isPressed3 = YOURCODE; // If the button is not being pressed, what value should isPressed have?
  }
